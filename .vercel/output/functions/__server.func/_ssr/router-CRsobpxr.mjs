...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CRsobpxr.js
...
var styles_default = "/assets/styles-8tN5kTca.css";
var APP_NAME = "SUNDER";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A violent physical sandbox. Bodies, fire, crowds, and weather collide."
			},
			{
				name: "theme-color",
				content: "#0c0b0a"
...
var $$splitComponentImporter = () => import("./routes-Cwd1k7r-.mjs").then((n) => n.t);
